...
import testimonial1Image from "../pages/Testimonials-images/testimonial1Initials.png";
import testimonial2Image from "../pages/Testimonials-images/testimonial2Initials.png";
import testimonial3Image from "../pages/Testimonials-images/testimonial3Initials.png";
import testimonial4Image from "../pages/Testimonials-images/testimonial4Initials.png";
import testimonial5Image from "../pages/Testimonials-images/testimonial5Initials.png";
import testimonial6Image from "../pages/Testimonials-images/testimonial6Initials.png";
import testimonial7Image from "../pages/Testimonials-images/testimonial7Initials.png";
import testimonial8Image from "../pages/Testimonials-images/testimonial8Initials.png";
import testimonial9Image from "../pages/Testimonials-images/testimonial9Initials.png";
import testimonial10Image from "../pages/Testimonials-images/testimonial10Initials.jpg";
              ...
              <div className="tw-card" key={item.name}>
                ...
                <div className="tw-card-top">
                  <div className="tw-avatar">
                    ...
                    />
                    <span className="tw-avatar-fallback" style={{ display: "none" }}>
                      {t(item.initials)}
                    </span>
                  </div>
