...
const ContactMe = () => {
        ...
        <View className="relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <View className="lg:col-span-5 space-y-6">
            ...
            <H2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-stone-100 tracking-tight leading-[1.15]">
             {t("contactHeading")}{" "} <Span className="italic font-light text-amber-200 cm-underline-word"> {t("contactHeadingHighlight")} </Span>
            </H2>
  ...
  <a
    ...
    rel="noreferrer"
  >
    "{item.key === "location" ? t("locationValue") : item.value}"
  </a>
) : (
  <span className="term-str">"{item.key === "location" ? t("locationValue") : item.value}"</span>
)}
                      <span className="term-punc">,</span>
