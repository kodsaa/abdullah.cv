...
>
        ...
        >
          {t(`technicalExpertise.items.${item.id}.title`)}
        </H3>
        </View>

        <Text className="text-stone-200 text-sm leading-7 mb-6">
          {t(`technicalExpertise.items.${item.id}.description`)}
        </Text>
        ...
        <Button onClick={() => navigate(`/skill/${item.id}`)} className="bg-transparent mt-4 text-amber-500 "> {t("technicalExpertise.viewOccupation")}</Button>
      </Card>
    </div>
  );
};
...
const TechnicalExpertise = () => {
  ...
  <View className="inline-flex items-center gap-2 mb-1">
    ...
    >
      {t("technicalExpertise.sectionLabel")}
    </Span>
  ...
  <H2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight">
    ...
    >
      {t("technicalExpertise.headingPart1")}
    </Span>
    ...
    >
      {t("technicalExpertise.headingPart2")}
    </Span>
  </H2>
  ...
  <Trans i18nKey="technicalExpertise.paragraph">
  Building{" "}
  <Span className="font-serif italic theme_section_paragraph_highlight">
    {{ scalable: t("technicalExpertise.paragraphHighlights.scalable") }}
  </Span>{" "}
  through modern{" "}
  <Span className="font-serif italic theme_section_paragraph_highlight">
    {{ architecture: t("technicalExpertise.paragraphHighlights.architecture") }}
  </Span>
  , integrating{" "}
  <Span className="font-serif italic theme_section_paragraph_highlight">
    {{ ai: t("technicalExpertise.paragraphHighlights.ai") }}
  </Span>
  , and delivering{" "}
  <Span className="font-serif italic theme_section_paragraph_highlight_secondary">
    {{ production: t("technicalExpertise.paragraphHighlights.production") }}
  </Span>{" "}
