...
import Reveal from "./Reveal"; // Import your GPU-accelerated Reveal component
...
const Experience = () => {
  ...
  return (
    <Container id="experience" className="max-w-7xl mx-auto py-20 sm:py-24 px-4 sm:px-6">
      ...
      <Reveal variant="fade-down" preset="smooth">
